"""
Fingerprint parameter variants for browser emulation.
All variants are grouped by platform: Win64, MacIntel, Linux x86_64.
"""

# WebGL parameters with real GPU values
webgl_variants = {
    "Win64": [
        # NVIDIA
...
# Canvas noise parameters per platform
canvas_variants = {
    "Win64": [
...
# Audio fingerprint noise intensity per platform
audio_variants = {
    "Win64": [
...
# Fake local IP sets for WebRTC masking
local_ip_variants = [
    # Home subnets
...
# Hardware characteristics per platform
hardware_variants = {
    "Win64": [
...
# Screen resolution and DPI variants per platform
screen_variants = {
    "Win64": [
...
# User behavior simulation variants
user_behavior_variants = {
    "mouse": {
        "moveSpeed":        [0.8, 1.0, 1.2, 1.5],   # mouse movement speed multiplier
        "clickDelay":       [50, 100, 150, 200],      # delay between clicks in ms
        "doubleClickDelay": [200, 250, 300, 350],     # double-click delay in ms
    },
    "keyboard": {
        "typingSpeed":    [100, 150, 200, 250],       # ms between keystrokes
        "typingVariance": [10, 20, 30, 40],           # variance in typing speed in ms
        "keyPressTime":   [50, 70, 90, 110],          # key hold duration in ms
    },
    "scroll": {
        "speed":      [100, 150, 200, 250],           # scroll speed units
        "smoothness": [0.8, 0.9, 1.0, 1.1],          # scroll smoothness factor
        "pauseTime":  [500, 1000, 1500, 2000],        # pause between scrolls in ms
    },
}

# Browser history simulation variants
history_variants = {
    "visitFrequency": [
    ...
    "historyDepth":  [7, 14, 30, 60],   # days
}

# Network behavior simulation variants
network_variants = {
    "bandwidth": [
    ...
    "packetLoss":     [0.0, 0.1, 0.2, 0.5],            # packet loss percentage
